...
<nav>           
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : black;">Send Money</h2>
            <?php
               if (isset($_GET['id'])){
                include 'connection.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered">
                ...
                <tr style="color : black;">
                    <td class="py-2"><?php if (!empty($rows)) echo $rows['id'] ?></td>
                    <td class="py-2"><?php if (!empty($rows))echo $rows['name'] ?></td>
                    <td class="py-2"><?php if (!empty($rows)) echo $rows['email'] ?></td>
